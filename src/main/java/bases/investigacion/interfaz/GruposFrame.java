...
public class GruposFrame extends javax.swing.JFrame {
    ...
    public void panelIntegrantesCambiar(){
        GrupoIntegrantes p = new GrupoIntegrantes();
        p.setSize(variablePanel.getWidth(),variablePanel.getHeight());
        p.setLocation(0,0);
