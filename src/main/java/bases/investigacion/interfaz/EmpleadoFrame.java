...
import bases.investigacion.interfaz.paneles.empleado.EmpleadoPerfil;
import bases.investigacion.interfaz.paneles.empleado.EmpleadoLaboratorio;
import bases.investigacion.interfaz.paneles.empleado.EmpleadoGrupos;
...
public class EmpleadoFrame extends javax.swing.JFrame {
    ...
    public void panelPerfilCambiar(){
        EmpleadoPerfil home = new EmpleadoPerfil();
        home.setSize(variablePanel.getWidth(),variablePanel.getHeight());
        home.setLocation(0,0);
    ...
    public void panelProyectosCambiar(){
        EstudianteProyectos home = new EstudianteProyectos();
        home.setSize(variablePanel.getWidth(),variablePanel.getHeight());
        home.setLocation(0,0);
    ...
    public void panelGruposCambiar(){
        EmpleadoGrupos home = new EmpleadoGrupos();
        home.setSize(variablePanel.getWidth(),variablePanel.getHeight());
        home.setLocation(0,0);
    ...
    public void panelLaboratorioCambiar(){
        EmpleadoLaboratorio home = new EmpleadoLaboratorio();
        home.setSize(variablePanel.getWidth(),variablePanel.getHeight());
        home.setLocation(0,0);
    ...
    public void panelPublicacionesCambiar(){
        EstudiantePublicaciones home = new EstudiantePublicaciones();
        home.setSize(variablePanel.getWidth(),variablePanel.getHeight());
        home.setLocation(0,0);
    ...
    private void initComponents() {
        ...
        jButton3.setText("Ver publicaciones");
        ...
        jButton4.setText("Ver Laboratorios");
